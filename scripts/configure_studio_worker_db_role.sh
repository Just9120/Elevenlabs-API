...
verify_role() {
  ...
  [[ "$(psql_admin -Atqc "SELECT has_table_privilege('${ROLE_NAME}', 'transcription_jobs', 'SELECT') AND has_table_privilege('${ROLE_NAME}', 'transcription_jobs', 'UPDATE') AND has_table_privilege('${ROLE_NAME}', 'transcription_job_outputs', 'SELECT') AND has_table_privilege('${ROLE_NAME}', 'transcription_job_outputs', 'INSERT') AND has_table_privilege('${ROLE_NAME}', 'transcription_provider_part_checkpoints', 'SELECT') AND has_table_privilege('${ROLE_NAME}', 'transcription_provider_part_checkpoints', 'INSERT') AND has_table_privilege('${ROLE_NAME}', 'transcription_provider_part_checkpoints', 'DELETE') AND NOT has_table_privilege('${ROLE_NAME}', 'transcription_provider_part_checkpoints', 'UPDATE') AND NOT has_table_privilege('${ROLE_NAME}', 'transcription_provider_part_checkpoints', 'TRUNCATE') AND has_table_privilege('${ROLE_NAME}', 'diagnostic_events', 'DELETE')")" == "t" ]] || fail "worker required table privileges missing"
  [[ "$(psql_admin -Atqc "SELECT NOT (has_table_privilege('${ROLE_NAME}', 'sessions', 'SELECT') OR has_table_privilege('${ROLE_NAME}', 'sessions', 'INSERT') OR has_table_privilege('${ROLE_NAME}', 'sessions', 'UPDATE') OR has_table_privilege('${ROLE_NAME}', 'sessions', 'DELETE') OR has_table_privilege('${ROLE_NAME}', 'provider_credentials', 'INSERT') OR has_table_privilege('${ROLE_NAME}', 'provider_credentials', 'UPDATE') OR has_table_privilege('${ROLE_NAME}', 'provider_credentials', 'DELETE') OR has_table_privilege('${ROLE_NAME}', 'provider_account_snapshots', 'SELECT') OR has_table_privilege('${ROLE_NAME}', 'provider_account_snapshots', 'INSERT') OR has_table_privilege('${ROLE_NAME}', 'provider_account_snapshots', 'UPDATE') OR has_table_privilege('${ROLE_NAME}', 'provider_account_snapshots', 'DELETE'))")" == "t" ]] || fail "worker prohibited table privileges present"
