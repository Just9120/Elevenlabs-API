...
EXPECTED_HEAD="0012_output_reconciliation_cases"
...
validate_runtime_values() {
  ...
  in_range "${ENV_VALUES[STUDIO_WORKER_LEASE_HEARTBEAT_INTERVAL_SECONDS]}" 5 28800 || return 1
  (( ENV_VALUES[STUDIO_WORKER_LEASE_HEARTBEAT_INTERVAL_SECONDS] * 3 <= ENV_VALUES[STUDIO_WORKER_LEASE_TTL_SECONDS] )) || return 1
}
