...
The next approved implementation slice is an internal synchronous orchestrator contract only, separate from future worker/runtime invocation, public API behavior, and manifest authority. The approved internal composition is:
