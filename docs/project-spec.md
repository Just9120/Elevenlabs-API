...
Status: **🟦 IN PROGRESS — 92,9% (`13/14`)**. Существовавшие product AC, exact-main CI и deployment подтверждены; direct-upload progress реализуется в текущей рабочей ветке и ещё не доставлен в production.
