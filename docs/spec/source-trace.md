...
## Последующие решения владельца

| Источник | Решение | AC |
| --- | --- | --- |
| D20260924-PWA-UPDATE | После обсуждения текущего автоматического обновления владелец поручил узкую Goal: показывать новую версию PWA и дать выбор «Обновить сейчас» / «Позже», сохраняя ввод; проверять версию при возвращении к вкладке. Это новое дополнение к S001/S264, не изменение исходного Google Doc. | PC-15, PC-16 |
