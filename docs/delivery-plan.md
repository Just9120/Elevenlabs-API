...
- 👉 `PWA-BROWSER-INTEGRATION-BOUNDARY-01` — Reconcile the browser token/presigned-upload contract with the implemented Picker and local-upload flows — Current analysis item.
