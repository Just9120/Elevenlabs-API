...
- 👉 `DOCS-DELIVERY-ARCHIVE-01` — Next local item. Move completed historical gate chains out of the active dashboard into the delivery archive while preserving links, current blockers, and source priority without editing `project-spec.md`.
