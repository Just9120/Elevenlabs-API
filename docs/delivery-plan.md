...
The next allowed action is one of: repeat Phase 0 through the established production operator access path, or explicitly reprioritize delivery through a separate planning decision.
