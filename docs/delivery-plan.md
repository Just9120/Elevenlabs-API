...
- 👉 `BATCH-PRE-PR-GATE-01` — Reconcile the ten-commit infrastructure batch, review the complete `main...HEAD` diff and commit series, rerun the full applicable local gate, then publish one branch/PR without mixing in the next product item.
