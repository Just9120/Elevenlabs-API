...
- 👉 `DEPENDENCY-AUDIT-JOB-SUMMARY-01I` — Add always-running, non-sensitive Node/Python job summaries with exact revision and install/audit step outcomes while preserving job failure semantics.
