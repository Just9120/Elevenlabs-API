...
- 👉 `BATCH-PRE-PR-GATE-01` — Review the complete fifteen-commit `main...HEAD` diff and commit series, rerun the full applicable local gate, and record the publication-ready checkpoint without mixing in the next product item.
