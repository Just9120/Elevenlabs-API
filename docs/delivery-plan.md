...
- 👉 `PWA-AUTH-RETENTION-01` — Next local item. Add bounded cleanup for unambiguously expired authentication state without weakening audit, revocation, or active-session boundaries.
