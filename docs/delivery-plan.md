...
- `DOCS-AUTHORITY-SYNC-02` — correct status drift and consolidate `docs/provider-transcription-contract.md` and `VALIDATION_MATRIX.md` into their current authorities.
