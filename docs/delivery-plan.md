...
- 👉 `PWA-FRONTEND-MODULARIZATION-03A` — Next local item. Extract one behavior-preserving navigation/state authority from `App.tsx` with focused unit evidence, without reopening the broader deferred composer refactor.
