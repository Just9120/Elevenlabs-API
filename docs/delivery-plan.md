...
- 👉 `DEPENDENCY-AUDIT-HANDOFF-01F` — Add a concise validation-runbook handoff for local clean-audit reproduction and exact-revision GitHub dispatch/evidence, without publishing advisory details or treating retries as remediation.
