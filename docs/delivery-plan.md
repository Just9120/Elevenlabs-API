...
- 👉 `PWA-CSRF-RETRY-CONTRACT-01` — Next local item. Retry a mutation only after the server explicitly classifies an origin/CSRF rejection, not after every generic authentication or authorization response.
