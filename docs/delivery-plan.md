...
- 👉 `PWA-CONTAINER-REPRODUCIBILITY-01` — Next local item. Replace mutable frontend build/runtime inputs with reviewable immutable image identities while preserving the supported Node and nginx runtime contract.
