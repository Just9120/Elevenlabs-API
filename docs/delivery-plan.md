...
- 👉 `PWA-PROCESSING-ROLLOUT-01A / Gate 0A` — Establish the running worker's authority and perform an explicitly approved controlled drain/stop before repeating the read-only preflight.
