...
- Current step: подготовлен reviewable batch; PR ещё отсутствует, новые CI/CD ещё не выполнялись.
- **Next exact action:** создать commit согласованных документов, опубликовать ветку и PR, дождаться required checks; затем merge и applicable web delivery.
