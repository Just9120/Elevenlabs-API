...
| Project specification source of truth | Docs-only / needs ongoing review | `docs/project-spec.md` отражает current main after PR #49, включая optional speaker project rename workflow и experimental `LIVE-COLAB-01`. Требует поддержки при изменении scope. |
