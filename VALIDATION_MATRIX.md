...
| Realtime permission-cancellation behavior | Pending runtime validation | Attempt-scoped cancellation guards are implemented/static-tested; real browser prompt cancellation while prompts are open remains pending manual validation. |
