...
| Startup stale temp cleanup (`elevenlabs_api_*`, TTL-based) | Formally validated | Best-effort cleanup at startup only; scoped to project-owned temp names, no broad `/tmp` deletion. |
